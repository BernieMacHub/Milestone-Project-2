// hover effects all pages - done
// form button - done
// fix chess text error - done
// change question mark to envelope on contact and response page - done
// make noughts and crosses playable on mobile - done
// aria labels - done
...
function restartGame() {
    ...
    // Reset game state
    tog = 1; // White's turn
    whosTurn(); // Update the turn indicator to White's turn
